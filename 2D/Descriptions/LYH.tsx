export const LYHMarkup = (
  <>
    ...
    <p>
      I always aim to produce optimized products with the most decent size and
      most efficient performance. I strive to make the most out of the least
      amount of codes while not compromising the product content and speed at
      the same time.
    </p>
    <p>
